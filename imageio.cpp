...
/*
    ...
    You may edit it if you wish, but be aware that the staff may provide
...
static unsigned char *_load_image_RGBA_png(const char *fileName, int *width,
  int *height)
{
    // open the file
...
{
    int width = app_get_screen_width();
    int height = app_get_screen_height();
